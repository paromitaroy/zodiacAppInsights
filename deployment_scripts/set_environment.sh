...
export SIRMIONE_ALIAS=absirmione
export LIMONE_ALIAS=ablimone
export SCORPIO_ALIAS=abscorpio
export VIRGO_ALIAS=abvirgo
export LIBRA_ALIAS=ablibra
export ZODIAC_ALIAS=abzodiac
